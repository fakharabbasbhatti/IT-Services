    ...
    <div className="relative h-[100vh] max-h-[600px] flex justify-center items-center">
      ...
      <div className="absolute inset-0 bg-black/60 flex items-center px-4">
        <div className="text-white text-left max-w-4xl space-y-4 ml-4 md:ml-16">
          <p className="text-sm bg-[#697C84] hover:bg-[#a17d29] rounded-full font-light uppercase inline-block px-4 py-2">
            Experience Luxury Travel
          </p>
          <h1 className="text-3xl md:text-6xl font-bold leading-tight w-full md:w-[60%]">
            Explore the World Like Never Before
          </h1>
          <p className="text-[15px] md:text-xl font-light w-full md:w-[70%]">
            Curated journeys to the world's most extraordinary destinations. Let us transform your travel dreams into unforgettable memories.
          </p>
